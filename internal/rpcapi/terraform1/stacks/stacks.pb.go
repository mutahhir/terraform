...
type StackChangeProgress struct {
	...
	//	*StackChangeProgress_ActionInstances
...
func (x *StackChangeProgress) GetActionInstances() *ActionInstances {
	if x != nil {
		if x, ok := x.Event.(*StackChangeProgress_ActionInstances); ok {
...
type StackChangeProgress_ActionInstances struct {
	ActionInstances *ActionInstances `protobuf:"bytes,10,opt,name=action_instances,json=actionInstances,proto3,oneof"`
}
...
func (x *ActionInstances) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActionInstances) ProtoMessage() {}

func (x *ActionInstances) ProtoReflect() protoreflect.Message {
	mi := &file_stacks_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActionInstances.ProtoReflect.Descriptor instead.
func (*ActionInstances) Descriptor() ([]byte, []int) {
...
const file_stacks_proto_rawDesc = "" +
	...
	"\x19action_invocation_planned\x18\t \x01(\v2>.terraform1.stacks.StackChangeProgress.ActionInvocationPlannedH\x00R\x17actionInvocationPlanned\x12O\n" +
	"\x10action_instances\x18\n" +
	" \x01(\v2\".terraform1.stacks.ActionInstancesH\x00R\x0factionInstances\x1a\xb2\x02\n" +
